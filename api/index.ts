...
async createDocument(documentData: CreateDocumentRequest , params?: SearchDocumentsRequest): Promise<CreateDocumentResponse> {
  console.log("Creating document:", documentData);
  
  const response = await this.fetchWithTimeout(`/api/documents?userId=${params?.userId}`, {
    method: 'POST',
...
async processImage(requestData: ProcessImageRequest): Promise<ProcessImageResponse> {
  ...
  const response = await this.fetchWithTimeout('/api/process-image-data', {
    method: 'POST',
